...
| correctness | 27 | 216 | 边界、数值、布局、非对齐和常见规模 |
| stress | 8 | 64 | 维度/输入容量/相似度容量边界，手动长测 |
| fuzz | 64 | 512 | 固定 seed 的小尺寸随机组合 |
| 总计 | 104 | 832 | 自建本地回归集，非官方 15 点 |
...
| c24_negative_multitile | 2,17,257,40 | 全负数跨 N tile，检查持久 row-max 状态 |
| c25_bmn_first_group | 2,17,513,64 | 唯一最大值位于首个 N group |
| c26_bmn_group_winners | 2,17,1025,64 | 不同行最大值分布于四个 N group，检查跨组 Max 后再 Sum |

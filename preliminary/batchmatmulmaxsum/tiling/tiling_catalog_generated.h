...
enum class TilingKey : uint32_t {
    ...
    AUTO_MATMUL_FUSED_ASYNC_DB_M32 = 122,
...
constexpr StaticTilingConfig kTilingConfigs[] = {
    ...
    {TilingKey::AUTO_MATMUL_FUSED_ASYNC_DB_M32, "auto_matmul_fused_async_db_m32", KernelPath::AUTO_FUSED, MatmulSchedule::ASYNC, ReductionMode::VECTOR, 2, true, 32, 128, 64, 16, 128, 1},

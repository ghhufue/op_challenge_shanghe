...
`MEASURED` (scoped c20 msOpProf visualization round)
...
|---|---|
| Performance version | `v003` |
| Core implementation identity | Base commit `6bf577a9f6c68f9552f6ac4245eebd01164a629e` plus the documented v003 worktree change |
...
The later round 001 is a scoped visualization collection, not the standard
seven-group regression workflow. It produced real Details, Roofline, Cache,
and Raw Data pages. Timeline, Source, Warp Stall, On-Chip Memory, and
